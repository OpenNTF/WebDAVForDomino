 ...
 * 
 */
public class CategorizedDocumentOutputStream extends DominoOutputStream {
	/**
	 * Logger for Errors
	 */
	private static final Log LOGGER = LogFactory
			.getLog(CategorizedDocumentOutputStream.class);
	 ...
	 *            DAVResourceDomino
	 */
	public CategorizedDocumentOutputStream(
	 ...
	 *            DAVResourceDomino
	 */
	public void setResource(DAVResourceDominoCategorizedDocuments res) {
	...
	public void close() throws IOException {
		...
		DAVResourceDominoCategorizedDocuments res = (DAVResourceDominoCategorizedDocuments) this
				.getResource();
		if (res.isCollection()) {
			LOGGER.info("Problem! resource is collection");
			return;
		}
		DAVRepositoryDominoCategorizedDocuments repository = (DAVRepositoryDominoCategorizedDocuments) res
				.getRepository();

		String notesURL = res.getInternalAddress();
		LOGGER.info("Resource is not a collection; OK! Internal address="
				+ notesURL);
		...
		if (success) {
			...
			LOGGER.info("Removing the temp file(BUT NOT YET): " + trueFileName);
